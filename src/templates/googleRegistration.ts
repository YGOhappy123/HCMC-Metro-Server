type GoogleRegistrationTemplateProps = {
    title: string
    fullName: string
    username: string
    password: string
...
const googleRegistrationTemplate = ({ title, fullName, username, password, changePasswordUrl }: GoogleRegistrationTemplateProps) => `
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8" />
    ...
    <body>
        <div class="container">
            <div class="card">
                ...
                <p>Bạn đã đăng ký tài khoản thành công thông qua tài khoản Google của bạn</p>
                <p>Chào mừng bạn đến với HCMC Metro</p>
                <div class="spacing">
                    <p>Chúng tôi đã cấp cho bạn một tên đăng nhập và mật khẩu ngẫu nhiên</p>
                    <p>Tuy nhiên, bạn vẫn có thể đăng nhập thông qua tài khoản Google</p>
                </div>
                <div class="spacing">
...
export default googleRegistrationTemplate
